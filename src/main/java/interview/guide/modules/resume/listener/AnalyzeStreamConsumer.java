...
public class AnalyzeStreamConsumer {
    ...
    public void init(){
        ...
        try {
            // create consumer if it's not exists
            ...
            log.info("consumer group create or exists {}", AsyncTaskStreamConstants.RESUME_ANALYZE_GROUP_NAME);
        } catch (Exception e) {
            log.warn("consumer might be exists");
